...
export class Home implements OnInit {
  ...
  menuGroups: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        { label: 'Purchases', icon: 'M3 4h18M3 10h18M3 16h18M3 22h18', route: '/purchases' },
        { label: 'Expense Transactions', icon: 'M4 7h16M4 12h16M4 17h10', route: '/expense-transactions' },
      ]
    },
    {
      label: 'Reports',
      ...
      items: [
        { label: 'Debtors Statement Report', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V6m0 2v8m0 0v2m0-2c-1.11 0-2.08-.402-2.599-1M14.599 9C14.08 8.402 13.11 8 12 8M21 12a9 9 0 11-18 0 9 9 0 0118 0z', route: '/reports/debtors-statement' },
        { label: 'Trip Status', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', route: '/reports/trip-status' },
        { label: 'Expiring Permits', icon: 'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2', route: '/reports/expiring-permits' },
      ]
    },
    {
      label: 'Configuration',
      ...
      items: [
        ...
        { label: 'Issuing Authorities', icon: 'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2', route: '/issuing-bodies' },
        { label: 'Routes', icon: 'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2', route: '/routes' },
        ...
        { label: 'Vendors', icon: 'M4 7h16M4 12h16M4 17h10', route: '/vendors' },
        { label: 'Offloading Places', icon: 'M17.657 16.657L13.414 12.414A8 8 0 1112.414 13.414l4.243 4.243a1 1 0 01-1.414 1.414zM6 10a4 4 0 108 0 4 4 0 00-8 0z', route: '/offloading-places' },
        ...
        { label: 'Company Profile', icon: 'M12 4a8 8 0 100 16 8 8 0 000-16zm0 2a6 6 0 110 12A6 6 0 0112 6zm0 2a4 4 0 100 8 4 4 0 000-8z', route: '/company-profile' },
      ]
    },
    {
