...
- `items`: Array of vehicle income vs maintenance records
  ...
  - `grossIncome`: Revenue minus maintenance cost
...
- `totalGrossIncome`: Total revenue minus total maintenance cost
...
```typescript
{
  ...
  "vendorName": "string",
  "vendorTIN": "string",
  "transactionAmount": "number",# Trip Management API - Frontend Integration Guide
...
```typescript
{
  ...
  "licenseClass": "string",
  "licenseFrontPagePhoto": "string",# Trip Management API - Frontend Integration Guide
...
## Error Handling# Trip Management API - Frontend Integration Guide
